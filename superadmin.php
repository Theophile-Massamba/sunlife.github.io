...
<title>Health Care hospital KASONGO KUPA</title>
</head>
...
<h1 class="text-center ">Health Care Hospital<br /><small style="font-size:20px">Hospital Management System KASONGO KUPA</small></h1>
</div>
</div>
</div>
<br />
...
<div class="col-md-4 col-md-push-2  col-xs-12 ">
	...
	<br />
	<div align="center">
	<button name="login" onclick="chcke();"  type="submit" value="SUBMIT" class="btn ">VALIDER</button>
	<br>
...
Copyright © 2022 KASONGO KUPA Benjamin. All rights reserved.
        </div>
    </div>
    </div>
	</footer>
